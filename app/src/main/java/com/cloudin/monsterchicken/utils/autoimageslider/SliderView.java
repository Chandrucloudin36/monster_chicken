package com.cloudin.monsterchicken.utils.autoimageslider;

import static com.cloudin.monsterchicken.utils.autoimageslider.IndicatorView.draw.controller.AttributeController.getRtlMode;
...
import com.cloudin.monsterchicken.utils.autoimageslider.IndicatorView.PageIndicatorView;
import com.cloudin.monsterchicken.utils.autoimageslider.IndicatorView.animation.type.BaseAnimation;
import com.cloudin.monsterchicken.utils.autoimageslider.IndicatorView.animation.type.ColorAnimation;
import com.cloudin.monsterchicken.utils.autoimageslider.IndicatorView.animation.type.IndicatorAnimationType;
import com.cloudin.monsterchicken.utils.autoimageslider.IndicatorView.draw.controller.DrawController;
import com.cloudin.monsterchicken.utils.autoimageslider.IndicatorView.draw.data.Orientation;
import com.cloudin.monsterchicken.utils.autoimageslider.IndicatorView.draw.data.RtlMode;
import com.cloudin.monsterchicken.utils.autoimageslider.IndicatorView.utils.DensityUtils;
import com.cloudin.monsterchicken.utils.autoimageslider.InfiniteAdapter.InfinitePagerAdapter;
import com.cloudin.monsterchicken.utils.autoimageslider.Transformations.AntiClockSpinTransformation;
import com.cloudin.monsterchicken.utils.autoimageslider.Transformations.Clock_SpinTransformation;
import com.cloudin.monsterchicken.utils.autoimageslider.Transformations.CubeInDepthTransformation;
import com.cloudin.monsterchicken.utils.autoimageslider.Transformations.CubeInRotationTransformation;
import com.cloudin.monsterchicken.utils.autoimageslider.Transformations.CubeInScalingTransformation;
import com.cloudin.monsterchicken.utils.autoimageslider.Transformations.CubeOutDepthTransformation;
import com.cloudin.monsterchicken.utils.autoimageslider.Transformations.CubeOutRotationTransformation;
import com.cloudin.monsterchicken.utils.autoimageslider.Transformations.CubeOutScalingTransformation;
import com.cloudin.monsterchicken.utils.autoimageslider.Transformations.DepthTransformation;
import com.cloudin.monsterchicken.utils.autoimageslider.Transformations.FadeTransformation;
import com.cloudin.monsterchicken.utils.autoimageslider.Transformations.FanTransformation;
import com.cloudin.monsterchicken.utils.autoimageslider.Transformations.FidgetSpinTransformation;
import com.cloudin.monsterchicken.utils.autoimageslider.Transformations.GateTransformation;
import com.cloudin.monsterchicken.utils.autoimageslider.Transformations.HingeTransformation;
import com.cloudin.monsterchicken.utils.autoimageslider.Transformations.HorizontalFlipTransformation;
import com.cloudin.monsterchicken.utils.autoimageslider.Transformations.PopTransformation;
import com.cloudin.monsterchicken.utils.autoimageslider.Transformations.SimpleTransformation;
import com.cloudin.monsterchicken.utils.autoimageslider.Transformations.SpinnerTransformation;
import com.cloudin.monsterchicken.utils.autoimageslider.Transformations.TossTransformation;
import com.cloudin.monsterchicken.utils.autoimageslider.Transformations.VerticalFlipTransformation;
import com.cloudin.monsterchicken.utils.autoimageslider.Transformations.VerticalShutTransformation;
import com.cloudin.monsterchicken.utils.autoimageslider.Transformations.ZoomOutTransformation;
...
public class SliderView extends FrameLayout
    ...
    private void setUpAttributes(@NonNull Context context, AttributeSet attrs) {
        ...
        boolean sliderAutoCycleEnabled = typedArray.getBoolean(R.styleable.SliderView_sliderAutoCycleEnabled, false);
    ...
    public void setupSlideView(Context context) {
        mSliderPager = new SliderPager(context);
        mSliderPager.setOverScrollMode(OVER_SCROLL_NEVER);
