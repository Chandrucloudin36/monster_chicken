...
public class DashboardBannerSliderListAdapter extends
        SliderViewAdapter<DashboardBannerSliderListAdapter.SliderAdapterVH> {

    private Context context;
    private List<String> mSliderItems = new ArrayList<>();

    public DashboardBannerSliderListAdapter(Context context) {
    ...
    public SliderAdapterVH onCreateViewHolder(ViewGroup parent) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_dashboard_banners, null);
    ...
    public void onBindViewHolder(SliderAdapterVH viewHolder, final int position) {
        ...
        NativeUtils.INSTANCE.setLoadImage(viewHolder.ivBannerImage, sliderItem);
    }
